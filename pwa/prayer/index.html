...
function introScreen(){
  const html = `
    <div class="intro">
      <img id="introImg" src="prayer_images/intro_bible.png">
    </div>`;
  ...
  const html = `
    <div class="title-screen">
      <div class="title-content" id="titleContent">
        <img src="prayer_images/prayer_title.png">
  ...
  showSlide(`
    <div class="content">
      <div class="intro-content">
        ...
        <img src="prayer_images/praying_man.png">
  ...
  const html = `
    <div class="content learn-layout">
      <div class="learn-top image-area" onclick="forwardLearn()">
        <img src="prayer_images/prayer_${String(index+1).padStart(2,'0')}.png">
      </div>
...
function showPrayerGuideIntro(){
  ...
  showSlide(`
    <div class="content">
      <div class="intro-content">
        <img src="prayer_images/prayer_checklist.png" alt="Prayer checklist">
        <div>
  ...
  const html = `
    <div class="content">
      <div class="guide-image-area">
        <img src="prayer_images/prayer_${imageNumber}.png" alt="">
      </div>

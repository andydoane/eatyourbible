(function () {
  ...
  function makeCloudStrokes(d) {
    ...
    const useLongCloud = referenceCharCount
      ? referenceCharCount >= 12
      : targetRatio >= 3.25;

    const cloudPath = useLongCloud ? CLOUD_LONG_SVG_PATH : CLOUD_SVG_PATH;
    const cloudViewBox = useLongCloud ? CLOUD_LONG_SVG_VIEWBOX : CLOUD_SVG_VIEWBOX;
    const cloudSeed = useLongCloud ? "cloud-long" : "cloud";

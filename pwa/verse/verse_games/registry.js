...

{
  ...
  manifest: {
    ...
    icon: "🚗",
    iconImage: "./verse_images/game_icons/app_icon_traffic_tap.png",
    cardColor: "#a7cb6f",
    cardTextColor: "#ffffff",
  ...
  
  {
    ...
    manifest: {
      ...
      icon: "🚀",
      iconImage: "./verse_images/game_icons/app_icon_verse_launch.png",
      cardColor: "#7f66c6",
      cardTextColor: "#ffffff",
  ...
  
  {
    ...
    manifest: {
      ...
      icon: "🍉",
      iconImage: "./verse_images/game_icons/app_icon_food_slice.png",
      cardColor: "#ff5a51",
      cardTextColor: "#ffffff",
  ...
  
  {
    ...
    manifest: {
      ...
      icon: "🏰",
      iconImage: "./verse_images/game_icons/app_icon_tower_of_bible.png",
      cardColor: "#40b9c5",
      cardTextColor: "#ffffff",
...

  {
    ...
    manifest: {
      id: "versey_bird",
      title: "Versey Bird",
      description: "Flap and collect the verse in order.",
      icon: "🐦",
      iconImage: "./verse_images/game_icons/app_icon_versey_bird.png",
      cardColor: "#ffc751",
      cardTextColor: "#333333",
      launchUrl: "./verse_games/versey_bird/index.html",
      visibleInCarousel: true,
      progressType: "standard",
      modes: ["easy", "medium", "hard"]
    }
...

  {
    ...
    manifest: {
      ...
      icon: "🦖",
      iconImage: "./verse_images/game_icons/app_icon_dino_dash.png",
      cardColor: "#333333",
      cardTextColor: "#FFFFFF",
...

  {
    ...
    manifest: {
      ...
      icon: "😋",
      iconImage: "./verse_images/game_icons/app_icon_verse_munch.png",
      cardColor: "#7f66c6",
      cardTextColor: "#FFFFFF",
...

  {
    ...
    manifest: {
      ...
      icon: "👾",
      iconImage: "./verse_images/game_icons/app_icon_verse_invaders.png",
      cardColor: "#333333",
      cardTextColor: "#FFFFFF",
    ...
    manifest: {
      ...
      icon: "🐸",
      iconImage: "./verse_images/game_icons/app_icon_bible_bugs.png",
      cardColor: "#a7cb6f",
      cardTextColor: "#FFFFFF",
